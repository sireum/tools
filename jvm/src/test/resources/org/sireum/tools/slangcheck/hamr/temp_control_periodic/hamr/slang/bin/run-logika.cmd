...
val tcDir = home / "src" / "main" / "component" / "tc"
...
val files = ISZ[C](
  ...
  C(tcDir / "TempControlSoftwareSystem" / "TempControlPeriodic_p_tcproc_tempControl.scala", defaultOpts, emptyMap),
  C(tcDir / "TempSensor" / "TempSensorPeriodic_p_tcproc_tempSensor.scala", defaultOpts, emptyMap),
)
