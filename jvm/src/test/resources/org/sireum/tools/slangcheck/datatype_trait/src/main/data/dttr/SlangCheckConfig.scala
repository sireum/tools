...
@datatype class Config_TR_T(attempts: Z, additiveTypeFiltering: B, typeFilter: ISZ[TR_T_DataTypeId.Type], filter: TR_T => B) {}

@datatype class Config_L_X(attempts: Z, filter: L_X => B) {}
