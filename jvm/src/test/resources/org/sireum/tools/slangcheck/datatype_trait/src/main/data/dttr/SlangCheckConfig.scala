...
@datatype class Config_TR_T(attempts: Z, verbose: B, additiveTypeFiltering: B, typeFilter: ISZ[TR_T_DataTypeId.Type], filter: TR_T => B) {}

@datatype class Config_L_X(attempts: Z, verbose: B, filter: L_X => B) {}
